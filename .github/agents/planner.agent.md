...
- **Explore first**: Use #tool:search/codebase or #tool:search/fileSearch / #tool:search/textSearch to understand the existing architecture, file structure, and patterns.
...
Use the templates provided in [plan-template.md](../docs/plan-template.md).
